      ...
      <div className="flex w-full max-w-[420px] flex-col border-4 border-black bg-white shadow-[10px_10px_0_#000]">
        ...
        <div className="flex flex-col gap-5 p-7">
          <p className="font-mono text-sm leading-relaxed text-black">
            Sign in to draft emails with AI and send them from your own Gmail. Nothing sends
          ...
          >
            <svg width="22" height="22" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <path fill="#FBBC05" d="M5.29 14.29A7.2 7.2 0 0 1 4.91 12c0-.79.14-1.57.38-2.29v-3.1H1.29a12 12 0 0 0 0 10.78l4-3.1z" />
              <path fill="#EA4335" d="M12 4.77c1.76 0 3.34.61 4.58 1.8l3.44-3.44A11.97 11.97 0 0 0 12 0 12 12 0 0 0 1.29 6.61l4 3.1C6.23 6.88 8.88 4.77 12 4.77z" />
            </svg>
            Sign in with Google
          </button>
